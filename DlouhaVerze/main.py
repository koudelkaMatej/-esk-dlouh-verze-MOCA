...
class Screen(Carousel):
    def __init__(self, **kwargs):
        ...
        self.tests = { 1 : ("Prostorová orientace / zručnost", [ConnectTest(self),
                                                                CubeTest(self),
                                                                ClockTest(self)]),
                      2 : ("Pojmenování zvířete", [AnimalTestLion(self),
                                                   AnimalTestRhino(self),
                                                   AnimalTestCamel(self)]), 
                      3 : ("Pamět", [RememberTest(self)]),
                      4 : ("Pozornost", [NumberTest(self),
                                         LettersTest(self),
                                         SevenTest(self)]),
                      5 : ("Řeč", [SpeachRepeatTest(self),
                                   KTest(self)]),
                      6 : ("Abstrakce", [AbstractionTest(self)]),
                      7 : ("Pozdější vybavení slov", [AdvancedRememberTest(self)]),
                      8 : ("Orientace", [OrientationTest(self)]),
					  9 : ("Dokončeno", [DokoncitTest(self)])}
        try:
            self.welcome_screen()
