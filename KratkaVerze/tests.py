...
class AbstractionTest(Test):
	...
	def __init__(self, screen, **kwargs):
		...
		self.hodinky_pravitka_lb = Label(text="hodinky - pravítka", width=50, size_hint=(None, .1), font_size = "60px")
...
class AdvancedRememberTest(Test):
    ...
    def draw_uix(self):
        ...
        self.test_field.add_widget(Label(text="Kategorie", size_hint_x=.3))
